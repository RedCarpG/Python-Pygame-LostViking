...
import pygame
from abc import ABC
from ..basic_items.image_helper import LoopImageHelper
...
class MovableEntity(LoopImageHelper, ABC):
    ...
    def _move(self):
        """ Move its rect by its speed_x and speed_y"""
...
class InertialEntity(MovableEntity, ABC):
    ...
    def _inertial_deceleration(self):
        """ Decrease the speed_x or speed_y to 0 automatically
    ...
    def _accelerate_up(self):
        """ In crease the speed_y by _ACC_UP (negative)
        (Note: This method only change the value of speed_x / speed_y)
        """
    ...
    def _accelerate_down(self):
        """ In crease the speed_x by _ACC_DOWN (positive)
        (Note: This method only change the value of speed_x / speed_y)
        """
        self._move_flag_y = True
        # If speed doesn't reach limit
    ...
    def _accelerate_left(self):
        """ In crease the speed_x by _ACC_L (negative)
        (Note: This method only change the value of speed_x / speed_y)
        """
    ...
    def _accelerate_right(self):
        """ In crease the speed_x by _ACC_R (positive)
        (Note: This method only change the value of speed_x / speed_y)
        """
        self._move_flag_x = True
        # If speed doesn't reach limit
